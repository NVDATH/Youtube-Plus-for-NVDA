...
* ผู้ใช้สามารถใช้คำสั่ง control+c (คัดลอก) , control+x (ย้าย) , control+v (วาง) เพื่อย้ายตำแหน่งได้ 
    * สำหรับหน้าต่าง favorites video และ watch list สามารถคัดลอกและย้ายข้ามกันได้ แต่ favorites chanel + playlist จะใช้ได้แค่คำสั่งย้ายเพื่อย้ายตำแหน่งรายการในหน้าต่างตัวเองเท่านั้น
...
โดยที่ผู้ใช้สามารถกด enter เพื่อสั่งให้เปิดวิดีโอนั้นๆ ใน browser ได้ทันที หรือกด space bar เพื่อใช้ฟีเจอร์ quickAction ที่ผู้ใช้ตั้งค่าเอาไว้จากในหน้า [การตั้งค่า](#การตั้งค่า)
...
นอกจากหมวดหลักที่สร้างไว้ให้เป็นหมวดเริ่มต้นแล้ว ผู้ใช้ยังสามารถเพิ่มหมวดอื่นๆ เพื่อแบ่งการรับชมได้อย่างอิสระ และสามารถตั้งค่าได้ว่าคลิปจากช่องไหนจะเข้าไปอยู่ในหมวดใดบ้าง 
...
* ผู้ใช้สามารถเข้าถึงวิดีโอแต่ละรายการได้เหมือนส่วนอื่นๆ ที่เป็นรายการวิดีโอ การใช้ [ปุ่ม action](#actionbutton) หรือ [ปุ่ม copy](#copybutton) และกด enter เพื่อเปิดวิดีโอนั้นๆ 
...
* Update Feed  (Alt+u) - เป็นการสั่งให้ส่วนเสริมเช็กอัพเดตช่องทั้งหมดที่ผู้ใช้ sub ไว้ กรณีที่ไม่ได้ตั้งค่าให้ส่วนเสริมเช็กให้อัตโนมัติ หรือหากต้องการอัพเดตทันที ก็กดที่ปุ่มนี้ได้ โดยสคริปต์จะอัพเดต feed ให้เองอัตโนมัติทุกครั้งที่ผู้ใช้เปิด NVDA อยู่แล้วเป็นค่าปริยาย
...
หน้าต่างนี้ไว้สำหรับจัดการ profile ของผู้ใช้
โดยค่าปริยาย ส่วนเสริมจะมีโปรไฟล์ "default" มาให้
ผู้ใช้สามารถเพิ่มลบหรือแก้ไขชื่อได้จากหน้าต่างนี้
แต่หากต้องการสลับโปรไฟล์ ต้องเข้าไปแก้ไขจากในหน้า Settings ของส่วนเสริม

ในหน้าต่างนี้ผู้ใช้สามารถ

* กด F2 เพื่อแก้ไขชื่อโปรไฟล์ที่เลือกไว้ในรายการ
* กด delete เพื่อลบโปรไฟล์ที่เลือกไว้ในรายการ

** หมายเหตุ **: หากผู้ใช้ลบโปรไฟล์ เท่ากับลบไฟล์ฐานข้อมูลของโปรไฟล์นั้นๆ ไปด้วย ข้อมูลวิดีโอที่เคยบันทึกไว้ก็จะหายไปทั้งหมด
...
- **Default content types:** เลือกประเภทเนื้อหาที่จะดึงมาแสดงสำหรับช่องที่กดติดตามใหม่:
  ...
  - *Shorts (คลิปสั้น)*
  - *Live (ไลฟ์สตรีม)*
- **Background update interval:** กำหนดความถี่ในการตรวจสอบข้อมูลใหม่ของช่องที่ติดตาม สามารถปิด (Disabled) หรือตั้งเวลาได้ตั้งแต่ 15 นาที ถึง 24 ชั่วโมง โดยสคริปต์จะอัพเดต feed ให้เองอัตโนมัติทุกครั้งที่ผู้ใช้เปิด NVDA อยู่แล้วเป็นค่าปริยาย
