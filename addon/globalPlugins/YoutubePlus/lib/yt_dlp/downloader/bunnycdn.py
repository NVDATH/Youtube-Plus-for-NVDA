...
# Fixed by SCons:     def ping_thread(self, stop_event, url, headers, secret, context_id):
...
# Fixed by SCons:             md5_hash = hashlib.md5(f'{secret}_{context_id}_{time}_{paused}_{res}'.encode()).hexdigest()
